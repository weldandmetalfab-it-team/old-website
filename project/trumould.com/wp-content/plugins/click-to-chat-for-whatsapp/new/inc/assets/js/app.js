    ...
    t((function() {
        ...
        function m(e) {
            try {
                ...
                if (t(".ht_ctc_chat_greetings_box").length) {
                    ...
                    })), s.g_init && "user_closed" !== i("g_user_action") && ("default" == s.g_init ? "yes" !== n && l("init") : "open" == s.g_init && l("init")), t(document).on("click", '.ctc_greetings, #ctc_greetings, .ctc_greetings_now, [href="#ctc_greetings"]', (function(t) {
                        t.preventDefault(), g("element"), l("element")
                    }))
                }
            }(),
            function() {
        ...
        function y(_) {
            ...
            if ("" != o) {
                var h = "https://wa.me/" + o + "?text=" + i,
                    l = s.url_target_d ? s.url_target_d : "_blank";
                "yes" == n ? (s.url_structure_m && (h = "whatsapp://send?phone=" + o + "&text=" + i, l = "_self"), s.custom_url_m && "" !== s.custom_url_m && (h = s.custom_url_m)) : (s.url_structure_d && (h = "https://web.whatsapp.com/send?phone=" + o + "&text=" + i), s.custom_url_d && "" !== s.custom_url_d && (h = s.custom_url_d));
                var d = "popup" == l ? "scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no,width=788,height=514,left=100,top=100" : "noopener";
                window.open(h, l, d), s.chat_number = o,
                    function() {
                        ...
                        if (s.ga) {
                            ...
                            if ("undefined" != typeof dataLayer) try {
                                ...
                                function g(t) {
                                    t = t.toUpperCase(), d.includes(t) || (d.push(t), (t.startsWith("G-") || t.startsWith("GT-")) && (a.send_to = t, gtag("event", r, a), h++))
                                }
                            ...
                            0 == h && "no" == l && ("undefined" != typeof gtag ? gtag("event", r, a) : "undefined" != typeof ga && void 0 !== ga.getAll ? ga.getAll()[0].send("event", _, o, i) : "undefined" != typeof __gaTracker && __gaTracker("send", "event", _, o, i))
                        }
        ...
        "undefined" != typeof ht_ctc_variables ? u = ht_ctc_variables : (u = {
            ...
            function() {
                ...
                t(".ht_ctc_chat_greetings_box").hasClass("ctc_greetings_opened") ? g("user_closed") : l("user_opened")
            })), t(document).on("click", ".ctc_greetings_close_btn", (function(t) {
                g("user_closed")
            })), t(document).on("click", ".ht_ctc_chat_greetings_box_link", (function(e) {
                e.preventDefault(), document.querySelector("#ctc_opt") ? t("#ctc_opt").is(":checked") || i("g_optin") ? (y(h), d()) : t(".ctc_opt_in").show(400).fadeOut("1").fadeIn("1") : (y(h), d()), document.dispatchEvent(new CustomEvent("ht_ctc_event_greetings"))
