    ...
    function i(u, n, l) {
        (l = l || e || t.jQuery) && (n.prototype.option || (n.prototype.option = function(t) {
            ...
            if ("string" != typeof t) return o = t, this.each(function(t, e) {
                var i = l.data(e, u);
                i ? (i.option(o), i._init()) : (i = new n(e, o), l.data(e, u, i))
            }), this;
            var e, s, r, a, h, o, i = d.call(arguments, 1);
            return r = i, h = "$()." + u + '("' + (s = t) + '")', (e = this).each(function(t, e) {
                var i = l.data(e, u);
                if (i) {
                    var o = i[s];
                    if (o && "_" != s.charAt(0)) {
    ...
    function A(t) {
        if (function() {
                if (!C) {
                    ...
                    e.appendChild(t);
                    var i = v(t);
                    A.isBoxSizeOuter = I = 200 == y(i.width), e.removeChild(t)
                }
            ...
            for (var o = i.isBorderBox = "border-box" == e.boxSizing, n = 0; n < E; n++) {
                var s = b[n],
                    r = e[s],
                    a = parseFloat(r);
                i[s] = isNaN(a) ? 0 : a
            ...
            var h = i.paddingLeft + i.paddingRight,
                ...
                m = o && I,
                f = y(e.width);
            !1 !== f && (i.width = f + (m ? 0 : h + c));
            var g = y(e.height);
            return !1 !== g && (i.height = g + (m ? 0 : u + p)), i.innerWidth = i.width - (h + c), i.innerHeight = i.height - (u + p), i.outerWidth = i.width + l, i.outerHeight = i.height + d, i
        }
    }
...
function(n, s) {
    ...
    s.extend(c, e.prototype), c.option = function(t) {
        ...
        var i = a(r);
        return i.defaults = s.extend({}, r.defaults), s.extend(i.defaults, e), i.compatOptions = s.extend({}, r.compatOptions), i.namespace = t, i.data = r.data, i.Item = a(o), s.htmlInit(i, t), u && u.bridget && u.bridget(t, i), i
    };
    var p = {
        ms: 1,
        s: 1e3
...
function(t, e) {
    ...
    return e.compatOptions.fitWidth = "isFitWidth", e.prototype._resetLayout = function() {
        ...
        for (var o = this._getColGroup(i), n = Math.min.apply(Math, o), s = o.indexOf(n), r = {
                ...
                y: n
            }, a = n + t.size.outerHeight, h = this.cols + 1 - o.length, u = 0; u < h; u++) this.colYs[s + u] = a;
        return r
...
function(t) {
    ...
    "use strict";
    u.infinitescroll = function(t, e, i) {
        this.element = u(i), this._create(t, e) || (this.failed = !0)
    }, u.infinitescroll.defaults = {
        loading: {
            finished: l,
        ...
        prefill: !1,
        maxPage: l
    }, u.infinitescroll.prototype = {
        _binding: function(t) {
            var e = this,
                i = e.options;
            if (i.v = "2.0b2.120520", i.behavior && this["_binding_" + i.behavior] !== l) this["_binding_" + i.behavior].call(this);
            else {
        ...
        _create: function(t, o) {
            var n = u.extend(!0, {}, u.infinitescroll.defaults, t);
            this.options = n;
            var s = u(window);
            if (!this._validate(t)) return !1;
            var e = u(n.nextSelector).attr("href");
            if (!e) return this._debug("Navigation selector not found"), !1;
            n.path = n.path || this._determinepath(e), n.contentSelector = n.contentSelector || this.element, n.loading.selector = n.loading.selector || n.contentSelector, n.loading.msg = n.loading.msg || u('<div id="boostsed-infscr-loading"><img alt="Loading..." src="' + n.loading.img + '" /><div>' + n.loading.msgText + "</div></div>"), (new Image).src = n.loading.img, n.pixelsFromNavToBottom === l && (n.pixelsFromNavToBottom = u(document).height() - u(n.navSelector).offset().top, this._debug("pixelsFromNavToBottom: " + n.pixelsFromNavToBottom));
            var i = this;
            return n.loading.start = n.loading.start || function() {
                u(n.navSelector).hide(), n.loading.msg.appendTo(n.loading.selector).show(n.loading.speed, u.proxy(function() {
                    this.beginAjax(n)
                }, i))
            }, n.loading.finished = n.loading.finished || function() {
                n.state.isBeyondMaxPage || n.loading.msg.fadeOut(n.loading.speed)
            }, n.callback = function(t, e, i) {
                n.behavior && t["_callback_" + n.behavior] !== l && t["_callback_" + n.behavior].call(u(n.contentSelector)[0], e, i), o && o.call(u(n.contentSelector)[0], e, n, i), n.prefill && s.bind("resize.infinite-scroll", t._prefill)
            }, t.debug && (!Function.prototype.bind || "object" != typeof console && "function" != typeof console || "object" != typeof console.log || ["log", "info", "warn", "error", "assert", "dir", "clear", "profile", "profileEnd"].forEach(function(t) {
                console[t] = this.call(console[t], console)
            }, Function.prototype.bind)), this._setup(), n.prefill && this._prefill(), !0
        },
        _prefill: function() {
            function t() {
                return u(e.options.contentSelector).height() <= i.height()
            }
            var e = this,
                i = u(window);
            this._prefill = function() {
                t() && e.scroll(), i.bind("resize.infinite-scroll", function() {
        ...
        _determinepath: function(t) {
            var e = this.options;
            if (e.behavior && this["_determinepath_" + e.behavior] !== l) return this["_determinepath_" + e.behavior].call(this, t);
        ...
        _error: function(t) {
            var e = this.options;
            e.behavior && this["_error_" + e.behavior] !== l ? this["_error_" + e.behavior].call(this, t) : ("destroy" !== t && "end" !== t && (t = "unknown"), this._debug("Error", t), "end" !== t && !e.state.isBeyondMaxPage || this._showdonemsg(), e.state.isDone = !0, e.state.currPage = 1, e.state.isPaused = !1, e.state.isBeyondMaxPage = !1, this._binding("unbind"))
        },
        _loadcallback: function(t, e, i) {
            var o, n = this.options,
                s = this.options.callback,
                r = n.state.isDone ? "done" : n.appendCallback ? "append" : "no-append";
            if (n.behavior && this["_loadcallback_" + n.behavior] !== l) this["_loadcallback_" + n.behavior].call(this, t, e);
            else {
                switch (r) {
                    case "done":
                        return this._showdonemsg(), !1;
                    case "no-append":
                        if ("html" === n.dataType && (e = u(e = "<div>" + e + "</div>").find(n.itemSelector)), 0 === e.length) return this._error("end");
                        break;
                    case "append":
                        var a = t.children();
                        if (0 === a.length) return this._error("end");
                        for (o = document.createDocumentFragment(); t[0].firstChild;) o.appendChild(t[0].firstChild);
                        this._debug("contentSelector", u(n.contentSelector)[0]), u(n.contentSelector)[0].appendChild(o), e = a.get()
                }
                if (n.loading.finished.call(u(n.contentSelector)[0], n), n.animate) {
                    var h = u(window).scrollTop() + u(n.loading.msg).height() + n.extraScrollPx + "px";
                    u("html,body").animate({
                        scrollTop: h
                    }, 800, function() {
                        n.state.isDuringAjax = !1
                    })
                }
                n.animate || (n.state.isDuringAjax = !1), s(this, e, i), n.prefill && this._prefill()
            }
        },
        _nearbottom: function() {
            var t = this.options,
                e = 0 + u(document).height() - t.binder.scrollTop() - u(window).height();
            return t.behavior && this["_nearbottom_" + t.behavior] !== l ? this["_nearbottom_" + t.behavior].call(this) : (this._debug("math:", e, t.pixelsFromNavToBottom), e - t.bufferPx < t.pixelsFromNavToBottom)
        },
        _pausing: function(t) {
            var e = this.options;
            if (!e.behavior || this["_pausing_" + e.behavior] === l) {
        ...
        _setup: function() {
            var t = this.options;
            if (!t.behavior || this["_setup_" + t.behavior] === l) return this._binding("bind"), !1;
            this["_setup_" + t.behavior].call(this)
        },
        _showdonemsg: function() {
            var t = this.options;
            t.behavior && this["_showdonemsg_" + t.behavior] !== l ? this["_showdonemsg_" + t.behavior].call(this) : (t.loading.msg.find("img").hide().parent().find("div").html(t.loading.finishedMsg).animate({
                opacity: 1
            }, 2e3, function() {
                u(this).parent().fadeOut(t.loading.speed)
            }), t.errorCallback.call(u(t.contentSelector)[0], "done"))
        },
        _validate: function(t) {
            for (var e in t)
                if (e.indexOf && -1 < e.indexOf("Selector") && 0 === u(t[e]).length) return this._debug("Your " + e + " found no elements."), !1;
            return !0
        },
        bind: function() {
            this._binding("bind")
        ...
        beginAjax: function(n) {
            var s, r, t, a, h = this,
                e = n.path;
            if (n.state.currPage++, n.maxPage !== l && n.state.currPage > n.maxPage) return n.state.isBeyondMaxPage = !0, void this.destroy();
            switch (s = u(n.contentSelector).is("table, tbody") ? u("<tbody/>") : u("<div/>"), r = "function" == typeof e ? e(n.state.currPage) : e.join(n.state.currPage), h._debug("heading into ajax", r), t = "html" === n.dataType || "json" === n.dataType ? n.dataType : "html+callback", n.appendCallback && "html" === n.dataType && (t += "+callback"), t) {
                case "html+callback":
                    h._debug("Using HTML via .load() method"), s.load(r + " " + n.itemSelector, l, function(t) {
                        h._loadcallback(s, t, r)
                    });
                    break;
                case "html":
                    h._debug("Using " + t.toUpperCase() + " via $.ajax() method"), u.ajax({
                        url: r,
                        dataType: n.dataType,
                        complete: function(t, e) {
                            (a = void 0 !== t.isResolved ? t.isResolved() : "success" === e || "notmodified" === e) ? h._loadcallback(s, t.responseText, r): h._error("end")
                        }
                    });
                    break;
                case "json":
                    h._debug("Using " + t.toUpperCase() + " via $.ajax() method"), u.ajax({
                        ...
                        success: function(t, e, i) {
                            if (a = void 0 !== i.isResolved ? i.isResolved() : "success" === e || "notmodified" === e, n.appendCallback)
                                if (n.template !== l) {
                                    var o = n.template(t);
                                    s.append(o), a ? h._loadcallback(s, o) : h._error("end")
                                } else h._debug("template must be defined."), h._error("end");
                            else a ? h._loadcallback(s, t, r) : h._error("end")
                        },
                        error: function() {
        ...
        retrieve: function(t) {
            t = t || null;
            var e = this.options;
            if (e.behavior && this["retrieve_" + e.behavior] !== l) this["retrieve_" + e.behavior].call(this, t);
            else {
                if (e.state.isDestroyed) return this._debug("Instance is destroyed"), !1;
                e.state.isDuringAjax = !0, e.loading.start.call(u(e.contentSelector)[0], e)
            }
        },
        scroll: function() {
            var t = this.options,
                e = t.state;
            t.behavior && this["scroll_" + t.behavior] !== l ? this["scroll_" + t.behavior].call(this) : e.isDuringAjax || e.isInvalidPage || e.isDone || e.isDestroyed || e.isPaused || this._nearbottom() && this.retrieve()
        },
        toggle: function() {
            this._pausing()
        },
    ...
    }, u.fn.infinitescroll = function(e, i) {
        switch (typeof e) {
            case "string":
                var o = Array.prototype.slice.call(arguments, 1);
                this.each(function() {
                    var t = u.data(this, "infinitescroll");
                    return !!t && (!(!u.isFunction(t[e]) || "_" === e.charAt(0)) && void t[e].apply(t, o))
                });
                break;
            case "object":
                this.each(function() {
                    var t = u.data(this, "infinitescroll");
                    t ? t.update(e) : (t = new u.infinitescroll(e, i, this)).failed || u.data(this, "infinitescroll", t)
                })
        }
        return this
    };
    ...
    t.special.smartscroll = {
        setup: function() {
            u(this).bind("scroll", t.special.smartscroll.handler)
        },
        teardown: function() {
            u(this).unbind("scroll", t.special.smartscroll.handler)
        },
        handler: function(t, e) {
            var i = this,
                o = arguments;
            t.type = "smartscroll", n && clearTimeout(n), n = setTimeout(function() {
                u(i).trigger("smartscroll", o)
            }, "execAsap" === e ? 0 : 100)
        }
    }, u.fn.smartscroll = function(t) {
