! function() {
    ...
    n.fn.animate = function(e, i, t, o) {
        var s = n.speed(i, t, o);
        return s.complete = s.old, this.each(function() {
            this[r] || (this[r] = l++);
            var i = n.extend({}, s);
            d.apply(n(this), [e, n.extend({}, i)]), a[this[r]] = {
                run: !0,
                prop: e,
                opt: i,
                start: c(),
        ...
        return this.each(function() {
            this[r] || (this[r] = l++);
            var i = a[this[r]];
            i && i.run && (i.done += c() - i.start, i.done > i.opt.duration ? delete a[this[r]] : (n(this).stop(), i.run = !1))
        })
    }, n.fn.resume = function() {
        return this.each(function() {
            this[r] || (this[r] = l++);
            var i = a[this[r]];
            i && !i.run && (i.opt.duration -= i.done, i.done = 0, i.run = !0, i.start = c(), d.apply(n(this), [i.prop, n.extend({}, i.opt)]))
        })
    }
}(),
function(i) {
    ...
    s = 0, (r = function(i, e) {
        ...
        var t = {},
            o = this;
        if (o.animateHeight(), !0 === o.options.rtl && !1 === o.options.vertical && (i = -i), !1 === o.transformsEnabled) !1 === o.options.vertical ? o.$slideTrack.animate({
            left: i
            ...
            !0 === o.options.variableWidth && !1 === o.options.vertical && (s = o.options.speed * a(o.$slides.get(o.currentSlide - 1)).data("slick-width-factor")), o.myAnimation = o.$slideTrack.prop({
        ...
        } else o.applyTransition(), i = Math.ceil(i), !1 === o.options.vertical ? t[o.animType] = "translate3d(" + i + "px, 0px, 0px)" : t[o.animType] = "translate3d(0px," + i + "px, 0px)", o.$slideTrack.css(t), e && setTimeout(function() {
        ...
        var t = [];
        if (i.$slides.each(function(i, e) {
                a(e).attr("data-slick-index", i).data("originalStyling", a(e).attr("style") || ""), t.push(a(e).outerWidth())
    ...
    }, a(".jet-listing-grid__slider").length < 1 && (a.fn.slick = function() {
        var i, e, t = this,
            o = arguments[0],
