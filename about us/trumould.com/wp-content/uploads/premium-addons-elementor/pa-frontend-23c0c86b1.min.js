        ...
        var e = elementorModules.frontend.handlers.Base.extend({
            ...
            run: function() {
                var e = this,
                    ...
                    n = t.data("pagination");
                this.settings.activeCategory = s, this.settings.filterTabs = i, this.settings.filterTabs && this.filterTabs(), "masonry" !== this.settings.layout || this.settings.carousel || t.imagesLoaded(function() {
                    "*" === e.settings.activeCategory ? t.isotope(e.getIsoTopeSettings()) : t.isotope({
